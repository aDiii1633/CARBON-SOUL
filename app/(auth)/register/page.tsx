    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <Card className="w-full max-w-md bg-white border border-gray-200 shadow-xl rounded-2xl relative overflow-hidden">
        ...
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription>Enter details below to start tracking your footprint</CardDescription>
        </CardHeader>
        <CardContent>
          {error && (
            <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-lg flex items-start space-x-2 text-red-700 text-xs font-semibold animate-pulse">
